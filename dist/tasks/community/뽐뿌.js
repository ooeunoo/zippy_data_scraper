...
const task = task_constant_1.TASK_MAP.뽐뿌;
let 뽐뿌 = class 뽐뿌 extends page_task_1.PageTask {
    ...
    async getAuthor(page) {
        return page.evaluate(async () => {
            const _author = document.querySelector('#topTitle > div > ul > li.topTitle-name > strong > a');
    ...
    async getCreatedAt(page) {
        const createdAt = await page.evaluate(async () => {
            const _createdAt = document.querySelector('#topTitle > div > ul > li:nth-child(2)');
            return _createdAt
...
exports.뽐뿌 = 뽐뿌;
//# sourceMappingURL=%EB%BD%90%EB%BF%8C.js.map