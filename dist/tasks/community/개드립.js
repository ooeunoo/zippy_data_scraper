...
let 개드립 = class 개드립 extends page_task_1.PageTask {
    ...
    async getTitle(page) {
        return page.evaluate(async () => {
            const _title = document.querySelector('div.ed.article-head.margin-bottom-large > h4 > a');
            return _title.textContent.trim();
        });
    }
    async getAuthor(page) {
        return page.evaluate(async () => {
            const _author = document.querySelector('div.ed.flex.flex-wrap > span:nth-child(1) > a');
    ...
    async getCreatedAt(page) {
        ...
        return (0, time_1.calculateTimeAgo)(createdAt);
    }
...
exports.개드립 = 개드립;
//# sourceMappingURL=%EA%B0%9C%EB%93%9C%EB%A6%BD.js.map