...
const task = task_constant_1.TASK_MAP.네이트판;
let 네이트판 = class 네이트판 extends page_task_1.PageTask {
    ...
    async getContentImageUrl(page, baseUrl) {
        const contentImgUrl = await page.evaluate(async () => {
            ...
            if (_contentImgUrl.length > 1) {
                return (_a = _contentImgUrl[1]) === null || _a === void 0 ? void 0 : _a.getAttribute('href');
            }
            else {
                return (_b = _contentImgUrl[0]) === null || _b === void 0 ? void 0 : _b.getAttribute('href');
            }
        });
...
exports.네이트판 = 네이트판;
//# sourceMappingURL=%EB%84%A4%EC%9D%B4%ED%8A%B8%ED%8C%90%20copy.js.map